    ...
    <div>
      <div class="container mx-auto py-8">
        <div class="bg-white p-6 rounded-lg shadow-md">
          ...
          <h2 class="text-2xl font-semibold mt-8 mb-4">Nuestro Equipo</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="bg-blue-200 p-4 rounded-lg shadow-md">
              <h3 class="text-xl font-semibold mb-2">Juan Pérez</h3>
              <p class="text-gray-700">Experto en Horticultura</p>
            </div>

            <div class="bg-blue-200 p-4 rounded-lg shadow-md">
              <h3 class="text-xl font-semibold mb-2">María López</h3>
              <p class="text-gray-700">Especialista en Agricultura Orgánica</p>
            </div>

            <div class="bg-blue-200 p-4 rounded-lg shadow-md">
              <h3 class="text-xl font-semibold mb-2">Carlos Rodríguez</h3>
              <p class="text-gray-700">Diseñador de Jardines</p>
            </div>
          </div>
        </div>
      </div>
