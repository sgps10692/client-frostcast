...
const Notificaciones = () => {
  useEffect(() => {
    // establecer el elemento de menú desplegable
    const $targetEl = document.getElementById('dropdownNotification');
    // establece el elemento que activa el menú desplegable al hacer clic
    const $triggerEl = document.getElementById('dropdownNotificationButton');
    ...
    // comprobar si el menú desplegable está visible/abierto
    dropdown.isVisible();
  }, []);
  return (
    <div>
  ...
  <div className="divide-y divide-gray-100 dark:divide-gray-700">
    <a href="#" className="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
      <div className="w-full pl-3">
          <div className="text-gray-500 text-sm mb-1.5 dark:text-gray-400">Nueva predicción <span className="font-semibold text-gray-900 dark:text-white">Jese Leos</span>: "Nueva predicción de helada"</div>
          <div className="text-xs text-blue-600 dark:text-blue-500">Hace 3 minutos</div>
      </div>
    </a>
