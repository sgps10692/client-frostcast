...
import meterologo from 'public/meteo.png'
import equipo from 'public/equipo.png'
import fondo from 'public/fondo.png'
import fondo_nubes from 'public/fondo2.png'
import fondo_nubes2 from 'public/fondo3.png'
export default function Homeu() {
    return (
      <div className="bg-blue-600 h-screen flex flex-col items-center relative py-10 px-8">
        <div className="absolute inset-0 bg-contain bg-no-repeat" style={{ backgroundImage: `url(${fondo.src})`, zIndex: 0}}></div>
        <div className="absolute bottom-0 left-0 w-full h-1/2 bg-contain bg-no-repeat bg-bottom z-0" style={{ backgroundImage: `url(${fondo_nubes.src})`}}></div>
        <div className="absolute inset-0 bottom-0 left-0 w-full h-full bg-contain bg-no-repeat" style={{ backgroundImage: `url(${fondo_nubes2.src})`}}></div>
        ...
        <div className="h-screen flex items-center relative">
          ...
          <div className="flex flex-col items-center max-w-md text-center">
              <Image src={desarrollo} alt="Imagen 1" className="w-50 h-50"/>
            ...
            <div className="flex flex-col items-center max-w-md text-center">
              <Image src={meterologo} alt="Imagen 1" className="w-50 h-50 rounded-full" />
          ...
          <div className="flex flex-col items-center max-w-md text-center">
            <Image src={equipo} alt="Imagen 1" className="w-70 h-50 rounded-full" />
